...
resource "aws_s3_bucket" "elb_logs" {
  ...
  count         = local.enabled && var.tier == "WebServer" && var.environment_type == "LoadBalanced" && var.loadbalancer_type != "network" && !var.loadbalancer_is_shared && var.enable_alb_s3_logs == "true" ? 1 : 0
